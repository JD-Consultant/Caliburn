# AGENTS.md - Coding Behavior Contract
...
Use Codex for language-heavy tasks such as classification, summarization, drafting, extraction, and reasoning.
...
- **LLM**: Multi-provider (OpenAI / Google Gemini / Anthropic Codex) via `LLM_PROVIDER` env var; embedding always uses OpenAI `text-embedding-3-small`
