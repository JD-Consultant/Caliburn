...
| 專業顧問引擎 | R1 T1 IMPLEMENTED／R1 IN PROGRESS | greenfield strict contracts、8 案、rubric 與 deterministic verifier 已落地；runner／六臂 harness／provider／route 尚未實作，R1 gate 未通過 |
