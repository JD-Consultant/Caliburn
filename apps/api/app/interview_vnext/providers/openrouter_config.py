"""Secret-free production OpenRouter Chat profile.
...
`build_openrouter_config()`, which derives the accepted resolved model,
...
class OpenRouterChatConfig(DomainModel):
    ...
    contains_test_data: bool = True

    @model_validator(mode="after")
    def structural_invariants(self) -> "OpenRouterChatConfig":
...
def build_openrouter_binding(
    ...
    *,
    ...
    """Build one operation-specific binding over the immutable route config.
