...
修改 `app/job_analysis`、PostgreSQL adapter、HTTP route 或 Web seam 時，請同 commit 更新對應設計文檔與測試。已刪除的 OCS／interview 深文檔不再保留在 app docs，歷史研究只在 `docs/archive/`、`docs/specs/` 與 ADR 中作追溯資料。
