...
- [`plans/2026-07-20-interview-vnext-v3-5a-r5-grounded-short-answer-amendment-plan.md`](plans/2026-07-20-interview-vnext-v3-5a-r5-grounded-short-answer-amendment-plan.md) — **Approved、implementation in progress 的R5唯一詳細實作authority**：逐欄QuestionFrame／Evidence.v3／receipt／State.v3／commands/events、Context/Input/Output/Verifier 2.0.0、frequency policy、stale CAS、persistence/recovery/Capture closure、20-case matrix、full-green commits與交付格式；R5-A已由`bf35137`落地，R5-B暫由下列corrective阻擋。
- [`plans/2026-07-21-interview-vnext-v3-5a-r5-a-corrective-contract-closure-plan.md`](plans/2026-07-21-interview-vnext-v3-5a-r5-a-corrective-contract-closure-plan.md) — **Approved/planned、R5-B前置corrective**：把QuoteSpan／QuoteMatch ownership移到support模組，建立`support -> identifiers/base`、`evidence -> support`單向依賴，禁止late-import cycle；補QuestionFrame `closed_at >= opened_at`，鎖定schema byte不漂、fresh-process import、full no-network與real PostgreSQL gates。完成前不得開始R5-B。
