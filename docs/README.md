...
- [`adr/`](adr/) — Architecture Decision Records(決策的「為什麼」+ 取捨;**0001–0038**)；訪談AI核心架構為[ADR 0034](adr/0034-interview-ai-vnext-greenfield-evidence-workflow.md)，provider主線為[ADR 0035](adr/0035-interview-vnext-openrouter-first-provider-boundary.md)，runtime contract為[ADR 0036](adr/0036-interview-vnext-provider-binding-conformance-and-idless-turn-v2.md)，grounded short-answer／employee authority為[ADR 0037](adr/0037-interview-vnext-question-frame-contextual-evidence-and-employee-authority.md)，R5後Context Engine／專業顧問workflow／Authoring Core為[ADR 0038](adr/0038-interview-vnext-context-engine-and-professional-consultant-workflow.md)。
