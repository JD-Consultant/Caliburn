...
- [`specs/2026-07-20-interview-vnext-professional-job-analysis-and-short-answer-architecture-research.md`](specs/2026-07-20-interview-vnext-professional-job-analysis-and-short-answer-architecture-research.md) — **R5 前置、尚待 owner 裁決的職務分析研究（Revision 2）**：逐頁核對 AIoT 公版及現有 OCS editor/API/Qdrant，交叉閱讀 2025–2026 OpenAI、Anthropic、Google、iCAP、OPM、NIST、O*NET、ESCO 與大型 skills graph authority；提出 QuestionFrame + AnswerBinding + composite provenance 解決短回答，並定義 official/tenant Capability Catalog、no-match K/S discovery、task linkage、canonical authoring core 與可替換 editor/index/API adapters。既有元件不是限制；未回寫 mother plan 前不得直接實作。
