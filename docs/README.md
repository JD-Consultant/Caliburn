...
- [`specs/2026-08-10-legacy-cleanup-and-monorepo-boundary-design.md`](specs/2026-08-10-legacy-cleanup-and-monorepo-boundary-design.md) — **Proposed 第一階段清理設計**：只移除 zero-consumer 淘汰物；保留仍被 route 使用的 `app/interview`、隔離中的 `interview_vnext`／`job_authoring`，並整理現行／legacy／vNext 的 monorepo 與依賴邊界。
