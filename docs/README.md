...
- [`plans/2026-07-18-interview-vnext-v3-5-turn-eval-harness-plan.md`](plans/2026-07-18-interview-vnext-v3-5-turn-eval-harness-plan.md) — **可直接交付實作者的V3-5詳細規格（實作pending）**：依OpenAI/Anthropic 2026 eval官方指引與已live-verified OpenRouter路徑，逐檔定義repo-owned harness、12個固定繁中turn cases、runtime/gold隔離、fresh-session PostgreSQL replay、trial/attempt/disposition、Capture bundle、deterministic+blind human graders、precision/recall/qualifier與`pass^3` gate、CLI、測試、成本/停線與E0–E8 commits；通過只解鎖V3-6，不宣稱完整顧問或production品質。
