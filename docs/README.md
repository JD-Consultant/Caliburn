...
- [`specs/2026-07-20-interview-vnext-professional-job-analysis-and-short-answer-architecture-research.md`](specs/2026-07-20-interview-vnext-professional-job-analysis-and-short-answer-architecture-research.md) — **R5 前置、尚待 owner 裁決的職務分析研究**：逐頁核對 AIoT 公版及現有 OCS editor/Qdrant，交叉閱讀 2025–2026 OpenAI、Anthropic、Google、iCAP、OPM、O*NET、ESCO authority；提出 QuestionFrame + AnswerBinding + composite provenance 解決短回答，並定義 Evidence→主要職責／任務／產出／行為指標／K/S→既有 `_pending` 共編流程。未回寫 mother plan 前不得直接實作。
