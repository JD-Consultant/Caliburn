...
- [`plans/2026-07-18-interview-vnext-v3-5-turn-eval-harness-plan.md`](plans/2026-07-18-interview-vnext-v3-5-turn-eval-harness-plan.md) — **E0–E8 executable 已落地、true live待定案的V3-5詳細規格**：依OpenAI/Anthropic 2026 eval官方指引與已live-verified OpenRouter路徑，實作repo-owned harness、12個固定繁中turn cases、runtime/gold隔離、fresh-session PostgreSQL replay、trial/attempt/disposition、Capture bundle、deterministic+blind review、precision/recall/qualifier與`pass^3` gate、真OpenRouter orchestration、成本/停線與offline regrade；887 passed/0 skipped，通過只解鎖V3-6，不宣稱完整顧問或production品質。
