...
- [`plans/2026-07-20-interview-vnext-v3-5a-r5-grounded-short-answer-amendment-plan.md`](plans/2026-07-20-interview-vnext-v3-5a-r5-grounded-short-answer-amendment-plan.md) — **Approved/planned 的R5唯一詳細實作authority**：逐欄QuestionFrame／Evidence.v3／receipt／State.v3／commands/events、Context/Input/Output/Verifier 2.0.0、frequency policy、stale CAS、persistence/recovery/Capture closure、20-case matrix、full-green commits與交付格式；可直接交實作者，尚未寫code／跑live。
