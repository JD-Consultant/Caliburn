...
- [`plans/2026-07-17-interview-vnext-v3-4r-openrouter-first-adapter-plan.md`](plans/2026-07-17-interview-vnext-v3-4r-openrouter-first-adapter-plan.md) — **下一個可直接交接的V3-4R規格**：依OpenRouter 2026-07-17官方Chat/Structured Outputs/Models/Endpoints/Routing/Metadata/Errors/Usage/Plugins/Privacy與Beta狀態，逐欄固定direct HTTP、model snapshot、exact endpoint、fallback/plugins/cache off、single-call、error/usage/artifacts、route contamination matrix、live bundle、V3-5接法與production follow-ups；尚未實作。
