...
- [`plans/2026-08-03-r1-task-discovery-offline-implementation-plan.md`](plans/2026-08-03-r1-task-discovery-offline-implementation-plan.md) — **R1 現行施工計畫**：T1 authority、T2 prompt/schema/runners 與 T3 A1–A6/minimal baseline/immutable capture harness 已實作；下一步只做 T4 blind grader/CLI/preflight，另有付費授權時才做 live eval；未通過 gate 不進 R2。
...
- [`design/`](design/) — **子系統端到端設計(agent-facing)**；現有 [`editor-knowledge-pack.md`](design/editor-knowledge-pack.md)、[`interview-engine.md`](design/interview-engine.md)（ACTIVE／TRANSITIONAL）與 [`professional-consultant-engine.md`](design/professional-consultant-engine.md)（R1 T3 partial；新route未實作）。寫法見 [`design/README.md`](design/README.md)。
