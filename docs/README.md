...
- [`plans/2026-08-01-job-analysis-opks-first-slice-plan.md`](plans/2026-08-01-job-analysis-opks-first-slice-plan.md) — **待執行的 OPKS 第一切片**：依 ADR 0048–0051 以薄 `OpksItem`／獨立 `OpksProposal` 接通 Current JD persistence、員工手動編輯、單 Task O/P/K/S 提案、Web 與 scripted vertical；不做匯出、taxonomy、Reference Challenger、自動判級、Attitude AI 或通用 Proposal framework。
