...
- [`plans/2026-08-10-legacy-cleanup-and-monorepo-boundary-plan.md`](plans/2026-08-10-legacy-cleanup-and-monorepo-boundary-plan.md) — **執行中**：先以 route／import inventory 證明可刪範圍，再拆 `job_analysis` composition、鎖 Web current／legacy imports 並校正文檔；若沒有 zero-consumer tracked asset，明確以零刪除收斂，不硬切仍在使用的 legacy／vNext。
