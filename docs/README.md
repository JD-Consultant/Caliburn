...
- [`plans/2026-07-17-interview-vnext-v3-4-openai-responses-adapter-plan.md`](plans/2026-07-17-interview-vnext-v3-4-openai-responses-adapter-plan.md) — **V3-4可直接交接的詳細實作規格**：依2026-07-17官方Responses/Structured Outputs/error/model資料與專案鎖定OpenAI SDK 2.46.0實際型別，逐欄裁決exact portable schema、`responses.create`、SDK零隱藏retry、deadline、typed output/status/error/usage、deterministic artifacts、mocked HTTP fixtures與opt-in live Capture bundle；尚未實作，不代表模型品質已通過。
