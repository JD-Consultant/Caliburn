...
- [`adr/`](adr/) — Architecture Decision Records(決策的「為什麼」+ 取捨；**0001–0041**)；AI方向以[ADR 0040](adr/0040-professional-consultant-engine-and-r1-validation-contract.md)為準，production切換／退役以[ADR 0041](adr/0041-document-boundary-single-writer-cutover.md)為準。0038已被0040取代，勿據以開新工；0034的greenfield原則保留但operation catalog與state形狀不再沿用。
