...
- 部分取代：[0039](0039-local-multi-document-canonical-public-form-workspace.md)、
  [0054](0054-document-boundary-single-writer-cutover.md)、[0056](0056-real-employee-pilot-release-gate.md) 中的
...
7. ADR 0040／0055 的顧問與職務分析 gate、ADR 0054 的 document-boundary single writer、ADR 0056 的真實員工 pilot
