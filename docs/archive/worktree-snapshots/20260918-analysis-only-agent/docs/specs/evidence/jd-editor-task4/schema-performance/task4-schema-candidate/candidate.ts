 ...
 */
export type JdSavedTaskChild = JdSavedElement &
  (
    | JdSavedElementOfBodyType
    | {
        type: "jd_outcomes";
        [k: string]: unknown;
      }
 ...
 */
export type JdSavedKnowledgeSectionChild = JdSavedElement &
  (
    | JdSavedElementOfBodyType
    | {
        type: "jd_knowledge";
 ...
 */
export type JdSavedSkillsSectionChild = JdSavedElement &
  (
    | JdSavedElementOfBodyType
    | {
        type: "jd_skill";
...
export type JdChangeReadFailure = JdReadFailure;
