...
- [`adr/0070-consultant-workspace-ui-and-explicit-pending-edit-approval.md`](adr/0070-consultant-workspace-ui-and-explicit-pending-edit-approval.md) — **Proposed** 三欄顧問工作區、AI after-state 編輯仍待審、OPKS 未定位分流、ownership lifecycle 與 Web framework 方案 A。
...
- [`specs/2026-08-27-consultant-workspace-ui-and-pending-edit-semantics-design.md`](specs/2026-08-27-consultant-workspace-ui-and-pending-edit-semantics-design.md) — **待 owner 書面複核** 顧問工作區完整 UI／authority 設計、官方來源、framework mapping 與驗收情境。
