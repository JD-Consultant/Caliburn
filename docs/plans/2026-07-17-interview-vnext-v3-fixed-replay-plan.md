...
| V3-5（E0–E7完成、E8 true live待owner） | vNext eval harness + 12 turn tasks + 3-trial turn gate | 是 | harness全綠(886 passed)；true live 12×3 batch通過才繼續 |
