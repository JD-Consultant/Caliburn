...
| V3-5（E0–E8 executable完成、true live待執行） | vNext eval harness + 12 turn tasks + 3-trial turn gate | 是 | harness全綠(887 passed)；true live 12×3 batch通過才繼續 |
