...
3. 以 ADR 0055 記錄 owner 確認的混合式職務發現、T–T–O–P 形成順序與禁止事項。
...
- 研究紀錄、context map、JD 著作 glossary 與 ADR 0055 已建立。
- 現行 orientation／design／索引已指向 ADR 0055；既有 Accepted ADR 未修改。
