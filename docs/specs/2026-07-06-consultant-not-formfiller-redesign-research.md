...
### 16.12 T11 onboarding:空白起跑(2026-07-08;範圍務實化)
§9.3=空白起跑 + 手動 picker 平行保留。研究關卡:start 現在無任務即 409;widget 驅動
自動選職類(§11.2b:顧問 search 結果→程式轉預勾清單→送出觸發知識包同步 ADR 0021)是
較大整合,且顧問已能在對話裡**文字提議職類**(T7 smoke 實證:「你對應軟體測試工程人員
(ISD2519-002v2)…要不要查任務職能?」)。**T11 範圍**:放寬 start 允許空白 doc 起跑
(拿掉 409 no_tasks;無任務→focus 不設 task_path、phase=survey),顧問開場揭露+問「你做
