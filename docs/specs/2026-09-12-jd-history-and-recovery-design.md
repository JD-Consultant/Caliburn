...
本稿範圍已閉合；新增快捷依[HR-02](2026-09-12-jd-ai-turn-undo-design.md)，差異預設呈現依[CV-01 候選](2026-09-12-jd-change-visibility-design.md)討論，不據此稱整體 G4 通過。接續工程前置是 **瀏覽器恢復記錄的版本／容量、資料集識別的正式發配與備份還原關係，以及 successor DTO／原生瀏覽器有限驗證設計**。來源保持既有唯一權威，不能為填一個識別欄自行新增平行 catalog。Excel 版型／原始訪談匯出、完整 G4／ADR0075、施工與自然／真人驗收沿總計畫另完成。
