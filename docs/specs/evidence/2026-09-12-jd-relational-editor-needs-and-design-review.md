...
- 最新修訂：**JR-R01–05 均 DESIGN CLOSED**；R02／03 見[保存契約窄複核](2026-09-12-jd-relational-save-contract-review.md)，R01／04／05 與新增首敗見[完整業務複核](2026-09-12-jd-business-operations-review.md)。以下初審定位與反例保留作歷史，狀態依本段更新。Owner 已閉合草稿／歷史還原選擇，見[需求 §11](../2026-09-12-jd-relational-editing-requirements.md#11-本輪裁決草稿歷史與還原2026-09-12)；新責任與審查沿[歷史與恢復](../2026-09-12-jd-history-and-recovery-design.md)。暫存工程前置與整體 G4 未通過，不能將文件閉合稱產品已驗。
...
| 尚未歸任務的成果／要求 | 舊關係稿曾允許獨立保留，後續 Owner 明確選聊天或未完整任務，不另設資料區；不造假任務以滿足 FK。這是已確認的輸入情境取捨，不是 SQL 正誤 | **DR-01 已選；需求 §11** |
...
- 原 findings 已局部文件閉合，草稿／還原效果另經 Owner 選定；下一步沿歷史設計閉合暫存工程前置，再重評整體 G4／ADR0075。本稿不宣布新設計已完成。
