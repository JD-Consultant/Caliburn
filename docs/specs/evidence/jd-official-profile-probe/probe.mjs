...
function fresh(name, value, mode = 'normalize') {
  ...
  full(`${name}-process`, { status: proc.status, signal: proc.signal, pid: proc.pid, error: proc.error && { code: proc.error.code, message: proc.error.message }, stdout: proc.stdout, stderr: proc.stderr });
