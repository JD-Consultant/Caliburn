...
Adopted without matcher changes from analysis-only-agent commit
033540cef870d1f92baa5c69133a799231c46d48, analysis_agent/memory_patch.py.
The SDK is MIT; its public in-memory helper remains documented on 2026-09-13:
https://developers.openai.com/api/docs/guides/tools-apply-patch#use-the-apply-patch-tool-with-the-agents-sdk
"""
